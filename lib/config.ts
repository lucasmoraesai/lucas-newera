...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    who: "Startups e empresas sem CTO",
    body: "CTO fracionado com responsabilidade sobre arquitetura, stack, time e roadmap — sem contratar um CTO full-time. Direção técnica de quem já escalou produto de zero a R$ 8,6M/ano.",
    includes: [
      "Reunião mensal de direção",
      "Arquitetura, stack e segurança",
      "Construir, comprar ou integrar",
      "Contratação e gestão do time técnico",
      "Disponibilidade para founders",
      "Contrato anual",
    ],
    cadence: "/mês · anual",
    amount: 15000,
    seats: { taken: 0, total: 3 },
  },
  {
    id: "palestra",
    group: "evento",
